...
```{r}
#Loading data
LU <- read.csv("C:/Users/Annes/OneDrive - Aarhus universitet/Methods/METHODS_3/Methods_3_assignment_1/LU_train.csv")
head(LU)
demo <- read.csv("C:/Users/Annes/OneDrive - Aarhus universitet/Methods/METHODS_3/Methods_3_assignment_1/demo_train.csv")
head(demo)
token <- read.csv("C:/Users/Annes/OneDrive - Aarhus universitet/Methods/METHODS_3/Methods_3_assignment_1/token_train.csv")
head(token)
```
...
LU$Visit <- str_replace_all(LU$Visit, "visit","")
LU
